...
public class ResultTicket extends JFrame {
...
//	}
	public ResultTicket() {
		...
		JLabel busReservationNum = new JLabel(BusClassInfo.ticketCode);
		...
		JLabel lblNewLabel_4_2_3 = new JLabel(BusClassInfo.searchSeats);
